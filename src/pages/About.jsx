...
export default function About() {
  return (
    <main className="px-6 py-16 sm:px-8 lg:px-12">
      {/* about hero section - keeping this simple for now, will match Figma exactly later */}
      <section className="mx-auto max-w-5xl text-center">
        ...
        {/* supporting text explaining what Vetess is about */}
        ...
        {/* CTA buttons - primary goes to donate, secondary to veterans page */}
