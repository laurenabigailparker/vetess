    ...
    return (
      ...
      >
        {link.label}
          ...
          <Link
  to="/admin/login"
  className="rounded-md border border-gold-500 px-4 py-2 text-sm font-semibold transition hover:bg-gold-500 hover:text-navy-700"
  style={{ color: "#f1c40f" }}
>
  Admin Portal
</Link>
            ...
            <button
              ...
              className="whitespace-nowrap rounded-md bg-crimson-700 px-4 py-2 text-sm font-semibold text-white transition hover:bg-crimson-500"
            >
              Get Started Free
            </button>
          </div>
      ...
      {menuOpen && (
        <div className="fixed inset-0 z-[60] bg-[#1f3057] xl:hidden">
